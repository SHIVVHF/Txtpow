...
auth_users =  int(os.environ.get("ADMINS", ""))
sudo_users = int(os.environ.get("SUDOUSER", ""))
sudo_groups = int(os.environ.get("LOGGROUP", ""))
...
@AFK.on_message(
    (filters.chat(Config.GROUPS) | filters.chat(Config.AUTH_USERS)) &
    filters.incoming & filters.command("pro_txt", prefixes=prefixes)
)
async def pro_txt(bot: AFK, m: Message):
...
@AFK.on_message(
    (filters.chat(Config.GROUPS) | filters.chat(Config.AUTH_USERS)) &
    filters.incoming & filters.command("pro_top", prefixes=prefixes)
)
async def pro_top(bot: AFK, m: Message):
      #user = m.from_user.id if m.from_user is not None else None
    #if user is not None and user not in sudo_users:
...
@AFK.on_message(
    (filters.chat(Config.GROUPS) | filters.chat(Config.AUTH_USERS)) &
    filters.incoming & filters.command("pro_vision", prefixes=prefixes)
)
async def pro_vision(bot: AFK, m: Message):
     #user = m.from_user.id if m.from_user is not None else None
    #if user is not None and user not in sudo_users:
        #await m.reply("bhag bhosadi ke", quote=True)
        #return
...
@AFK.on_message(
    (filters.chat(Config.GROUPS) | filters.chat(Config.AUTH_USERS)) &
    filters.incoming & filters.command("adda_pdf", prefixes=prefixes)
)
async def adda_pdf(bot: AFK, m: Message):
     #user = m.from_user.id if m.from_user is not None else None
    #if user is not None and user not in sudo_users:
        #await m.reply("**bhag bhosadi ke**", quote=True)
        #return
...
@AFK.on_message(
    (filters.chat(Config.GROUPS) | filters.chat(Config.AUTH_USERS)) &
    filters.incoming & filters.command("pro_olive", prefixes=prefixes)
)
async def pro_olive(bot: AFK, m: Message):
      #user = m.from_user.id if m.from_user is not None else None
    #if user is not None and user not in sudo_users:
        #await m.reply("bhag bhosadi ke", quote=True)
        #return
...
@AFK.on_message(
    (filters.chat(Config.GROUPS) | filters.chat(Config.AUTH_USERS)) &
    filters.incoming & filters.command("pro_jw", prefixes=prefixes)
)
async def pro_jw(bot: AFK, m: Message):
     #user = m.from_user.id if m.from_user is not None else None
    #if user is not None and user not in sudo_users:
...
@AFK.on_message(
    (filters.chat(Config.GROUPS) | filters.chat(Config.AUTH_USERS)) &
    filters.incoming & filters.command("top", prefixes=prefixes)
)
async def top(bot: AFK, m: Message):
    #user = m.from_user.id if m.from_user is not None else None
    #if user is not None and user not in sudo_users:
        #await m.reply("**BHAG BHOSADI KE**", quote=True)
        #return
